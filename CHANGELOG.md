# [2.185.0](https://github.com/ayushTNM/revanced-patches/compare/v2.184.31...v2.185.0) (2023-09-20)


### Bug Fixes

* compile error ([0a27088](https://github.com/ayushTNM/revanced-patches/commit/0a27088c8d9bc34da792eeef0233f82f3f32d5ae))
* **music/custom-branding-music-name:** compile error in RVX Manager ([e0e6dad](https://github.com/ayushTNM/revanced-patches/commit/e0e6dadfe6b8afc01ea980b066f97d3c48228c45))
* **music/exclusive audio playback:** not compatible with latest version ([a1fa3a2](https://github.com/ayushTNM/revanced-patches/commit/a1fa3a2594c75b2f4c00d855e41a46191f7b8976))
* **music/hide-upgrade-button:** not compatible with latest version ([4eec203](https://github.com/ayushTNM/revanced-patches/commit/4eec203126bd8b74065e037ca0d3ae66f10fdc6f))
* **music/remember-video-quality:** not compatible with latest version ([b1adb5f](https://github.com/ayushTNM/revanced-patches/commit/b1adb5f58404c778950a024665b8c922105b4621))
* **music/settings:** blank screen appears when text input dialog is shown ([a14d53f](https://github.com/ayushTNM/revanced-patches/commit/a14d53f3989977a16e5c75c704190845c6249f0b))
* **music:** compile issues due to wrong decoding ([ba53f73](https://github.com/ayushTNM/revanced-patches/commit/ba53f73739369cc678d2cf7cc6ad21bdea383412))
* **overlay-button:** match vertical fullscreen icon with others ([#15](https://github.com/ayushTNM/revanced-patches/issues/15)) https://github.com/inotia00/ReVanced_Extended/issues/1221 ([5c4b9b0](https://github.com/ayushTNM/revanced-patches/commit/5c4b9b0a3d5f5932f32bd64bb5a16d23c00f7133))
* **overlay-buttons:** fullscreen icon does not match ([851dbcf](https://github.com/ayushTNM/revanced-patches/commit/851dbcf54e5ad30fef20a0f866fb5af5aa298492))
* patch error ([25d311b](https://github.com/ayushTNM/revanced-patches/commit/25d311ba325b756289d133157c6d830f88c6a10d))
* **reddit/open-links-externally:** exceptions occur in some manufacturers ROM ([dea655e](https://github.com/ayushTNM/revanced-patches/commit/dea655e3b6bc49b2368fa252749ec2a41cb0c316))
* **reddit/reddit-settings:** now when the patch is applied through the RVX Manager, the settings are added normally ([1528885](https://github.com/ayushTNM/revanced-patches/commit/152888535b6fea418b0ee3d2211a14adaa3d0ee0))
* **youtube/custom-branding-youtube-name:** takes too long to apply the patch in the RVX Manager ([441a9ec](https://github.com/ayushTNM/revanced-patches/commit/441a9ecd586ca0bf6f372e38d43d9c6ae57aa230))
* **youtube/default-video-quality:** rollback commit ([94a36ed](https://github.com/ayushTNM/revanced-patches/commit/94a36ed91a8f4323af32bb05b910fef70b5b6170))
* **youtube/enable-new-splash-animation:** remove android version restriction ([b4057ef](https://github.com/ayushTNM/revanced-patches/commit/b4057ef846d8c187ef10dcf4939141a85be88984))
* **youtube/hide-layout-components:** custom filters are separated by commas instead of line-by-line ([3ac0a6b](https://github.com/ayushTNM/revanced-patches/commit/3ac0a6ba8f408292308298bc970c7398b68dea30))
* **youtube/hide-layout-components:** expandable chip under videos not hidden in related videos ([a54954a](https://github.com/ayushTNM/revanced-patches/commit/a54954a5f0bddca40c9cfeed58899ca6c9002133))
* **youtube/hide-shorts-components:** sometimes shorts shelves are not hidden from the home feed ([39645be](https://github.com/ayushTNM/revanced-patches/commit/39645be39f8b4c3e1745bd56378a5946d0b38ccf))
* **youtube/hide-shorts-components:** wrong case notation ([fa76fe9](https://github.com/ayushTNM/revanced-patches/commit/fa76fe94578cc751631a135590bcaf599522056c))
* **youtube/hide-suggested-actions:** not hidden normally in some situations ([3d6307f](https://github.com/ayushTNM/revanced-patches/commit/3d6307f90faccb7270c06585cddf566ae06ea4fe))
* **youtube/hide-suggested-video-overlay:** overlay is not hidden in some case ([ebdc38a](https://github.com/ayushTNM/revanced-patches/commit/ebdc38aee31c2a5d29ac6b31ef409c02ebb432b7))
* **youtube/old-quality-layout:** does not work on tablet devices ([16c34b7](https://github.com/ayushTNM/revanced-patches/commit/16c34b78f0d2a14fb73e6c330c7f702075ad77e3))
* **youtube/overlay-button:** overlay button not hidden when scrubbing seekbar ([7164f72](https://github.com/ayushTNM/revanced-patches/commit/7164f729f4b64a050f8371ad17f457d2b30c1650))
* **youtube/overlay-buttons:** `Disable playlist autoplay` loops video in minimized and PiP mode ([59edd59](https://github.com/ayushTNM/revanced-patches/commit/59edd59e013c37ad96d91725e941a72b61cc8335))
* **youtube/overlay-buttons:** remove unnecessary dependencies ([a58a05a](https://github.com/ayushTNM/revanced-patches/commit/a58a05a287ddffe149fbe320fdc0f6d85b83f43d))
* **youtube/settings:** wrong alphabetical alignment ([b1e8a1c](https://github.com/ayushTNM/revanced-patches/commit/b1e8a1cecb112f5de28dca25aae62f66d2b5cf63))
* **youtube/sponsorblock:** fix some segments skipping slightly too late ([8a748e9](https://github.com/ayushTNM/revanced-patches/commit/8a748e979ec959f2c9e84dc90901520c1481be63))
* **youtube/spoof-app-version:** change target version `17.30.34` > `17.08.35` ([e26d7be](https://github.com/ayushTNM/revanced-patches/commit/e26d7be200c734c7b82622df00f5df7c2350c689))
* **youtube/swipe-controls:** When `Press-to-swipe` is disabled, `Press-to-swipe haptic feedback` should also be disabled https://github.com/inotia00/ReVanced_Extended/issues/811 ([95cfc3d](https://github.com/ayushTNM/revanced-patches/commit/95cfc3de897ecf40c5c6dc2ede2eee5069727615))
* **youtube:** reinforce weak fingerprints ([1320590](https://github.com/ayushTNM/revanced-patches/commit/13205906ae01cbf2e375dcc55dd58a844f299307))
* **youtube:** remove dummy code ([f65d9a8](https://github.com/ayushTNM/revanced-patches/commit/f65d9a89b3ea1fe0086e271f9cbeb0f58c4a19d9))
* **youtube:** some dependence is missing https://github.com/inotia00/ReVanced_Extended/issues/1291 ([4d2fd8f](https://github.com/ayushTNM/revanced-patches/commit/4d2fd8ff06808851cdfa4b71443e6a04246d0cb5))
* **youtube:** some fingerprints are located in the wrong path ([2549347](https://github.com/ayushTNM/revanced-patches/commit/25493473b51b69a612cf680060d03f7bc0b9ec02))


### Features

* add microg patches ([709b2eb](https://github.com/ayushTNM/revanced-patches/commit/709b2eb2e99c37412afc853b9f51fc5cdb85b61c))
* generate an exception when an invalid value is entered ([63b0227](https://github.com/ayushTNM/revanced-patches/commit/63b0227e2a29efa51e0f885db2bf9d207bb81271))
* **microg:** add microg-mmt-icon and microg-materialyou patches ([#12](https://github.com/ayushTNM/revanced-patches/issues/12)) ([84fd6a8](https://github.com/ayushTNM/revanced-patches/commit/84fd6a82e6e2f91802b90bd928cb86af61483f94))
* **microg:** minor improvement ([09d5313](https://github.com/ayushTNM/revanced-patches/commit/09d531382387e649896e92c905b3ac65317c3eea))
* **microg:** temporary suspension of support for all patches https://github.com/inotia00/ReVanced_Extended/issues/1207 ([03b9875](https://github.com/ayushTNM/revanced-patches/commit/03b9875d164a465165dbbe2fde5789c8adcd9353))
* **music/amoled:** patch now applies the amoled theme to the comment input box as well ([f0dfbd2](https://github.com/ayushTNM/revanced-patches/commit/f0dfbd27ee408c50afe9d52ccfdaded4775d4c9a))
* **music/enable-custom-filter:** separate filters by line instead of commas ([2afe861](https://github.com/ayushTNM/revanced-patches/commit/2afe8614cc7f29e6826587fca00d930d3cf17fd1))
* **music/enable-new-layout:** change default value ([30b4ae7](https://github.com/ayushTNM/revanced-patches/commit/30b4ae71fda4d87b07e16a5ddb4957f39820bbcb))
* **music/enable-new-layout:** forcibly disable when the switch is off ([939a403](https://github.com/ayushTNM/revanced-patches/commit/939a40314b968172a7db291860211f51301498c3))
* **music/enable-sleep-timer:** forcibly disable when the switch is off ([00a3694](https://github.com/ayushTNM/revanced-patches/commit/00a36941f392425869cd2212767d2d4f31d4622f))
* **music/hide-get-premium:** patch now also hides the premium membership label in settings ([0473a62](https://github.com/ayushTNM/revanced-patches/commit/0473a627491dc26a58fc281bd5fdee64839af832))
* **music/microg-support:** renamed patch name ([58dd674](https://github.com/ayushTNM/revanced-patches/commit/58dd674ce67e106018a9a03c6aeef1d0a39bb149))
* **music/music-translations:** update translation ([74657e8](https://github.com/ayushTNM/revanced-patches/commit/74657e8530afbbe26917ce9d4b1dcedfdbe7edce))
* **music/music-translations:** update translation ([0f33289](https://github.com/ayushTNM/revanced-patches/commit/0f33289982f544eb2b7945d824727cb46bb17d35))
* **music/music-translations:** update translation ([167b6d1](https://github.com/ayushTNM/revanced-patches/commit/167b6d1da040796519091e63300ae85d448b8f69))
* **music/music-translations:** update translation ([af39d0c](https://github.com/ayushTNM/revanced-patches/commit/af39d0c5f63a040e5f2506669cfb98e416bea5a6))
* **music/music-translations:** update translation ([3066e1c](https://github.com/ayushTNM/revanced-patches/commit/3066e1cafaaa3969cc3108066397cac253601872))
* **music/settings:** change some default value ([2c16e7e](https://github.com/ayushTNM/revanced-patches/commit/2c16e7e61836526ce77e0ae8ad9945e5f498a33e))
* **music/translations:** update translation ([ac1d310](https://github.com/ayushTNM/revanced-patches/commit/ac1d310bf7ea3305d96f0c182d61602bb5c0fbad))
* **music/translations:** update translation ([f51a23f](https://github.com/ayushTNM/revanced-patches/commit/f51a23fd2c7f912dc0e99d18a89f683b97498a0a))
* **music/translations:** update translation ([ec92314](https://github.com/ayushTNM/revanced-patches/commit/ec92314e33d8c5269d248ed41bce891ef805ca29))
* **music:** add `enable playback speed` patch ([63628d6](https://github.com/ayushTNM/revanced-patches/commit/63628d6f75de4683f9bcf20aeecb4a74e53cfcf3))
* **music:** add `enable-old-style-library-shelf` patch ([6abfa67](https://github.com/ayushTNM/revanced-patches/commit/6abfa670ac14f87f43eeb54c58d11bbac0c9499f))
* **music:** add `hide-button-container-labels` patch ([2eff3d2](https://github.com/ayushTNM/revanced-patches/commit/2eff3d2f0a6a864f0645b9b7ef505b7155e1eccc))
* **music:** add `hide-channel-guidelines` patch ([98c8214](https://github.com/ayushTNM/revanced-patches/commit/98c82149541ef13d9346199623838357276ac513))
* **music:** add `hide-emoji-picker` patch ([45fcce5](https://github.com/ayushTNM/revanced-patches/commit/45fcce50c844b35b0b4e643e0c56e6542f99f11e))
* **music:** add `hide-flyout-panel` patch ([bc8338a](https://github.com/ayushTNM/revanced-patches/commit/bc8338a85ada735f6b9c5ea9bf6b2988e2b5eb72))
* **music:** add `hide-radio-button` patch ([3c306eb](https://github.com/ayushTNM/revanced-patches/commit/3c306ebcca153d929699e46c9388e569229f7865))
* **music:** add `remember-playback-speed` patch ([679e11e](https://github.com/ayushTNM/revanced-patches/commit/679e11e5d1424ad2b1aad36041bebcca93987a03))
* **music:** add `return-youtube-dislike` patch ([f97d6de](https://github.com/ayushTNM/revanced-patches/commit/f97d6de1c57b1d19ab9b6164e1043f37e66b2903))
* **music:** add compatibility version constraints (ryd does not support older versions) ([c5a68bf](https://github.com/ayushTNM/revanced-patches/commit/c5a68bf7142e2e4f7fb6d4dc83caecfceacd9e59))
* **music:** change patch description ([b9f2fca](https://github.com/ayushTNM/revanced-patches/commit/b9f2fcaf7ca5edfd3b76c9864c25758ef9d2dfd6))
* **music:** remove `enable-dismiss-queue` patch (applied to all users) ([3663d07](https://github.com/ayushTNM/revanced-patches/commit/3663d072b944f1f745cdb1cbc57a3d819591f940))
* **reddit/hide-ads:** add missing dependency ([d5e8fad](https://github.com/ayushTNM/revanced-patches/commit/d5e8fad3b82ef4c27a4624e256709985f313cd2e))
* **reddit/hide-ads:** implementing with settings ([263a3c5](https://github.com/ayushTNM/revanced-patches/commit/263a3c5c8c4faa2a09fc799631422a96d02eddd8))
* **reddit/hide-discover-community-button:** change patch name `hide-discover-button` > `hide-discover-community-button` ([360da14](https://github.com/ayushTNM/revanced-patches/commit/360da14efb774b1636f6cbce170cdb118a117514))
* **reddit/hide-navigation-buttons:** supports the latest version ([6b826bd](https://github.com/ayushTNM/revanced-patches/commit/6b826bd0f705a269f70eedce08d92b94ed1e9628))
* **reddit:** add `hide-place-button` patch ([b3a5631](https://github.com/ayushTNM/revanced-patches/commit/b3a5631f1426ca6429e3d662f9ede5e92ebfb974))
* **reddit:** remove `decoding-patch` that are no longer used ([ed6a45a](https://github.com/ayushTNM/revanced-patches/commit/ed6a45a269f01a16c5e0ee47093f665d6b39fcc5))
* remove `decoding-patch` that are no longer used ([c00af81](https://github.com/ayushTNM/revanced-patches/commit/c00af81a9b2d596e85451c00ae360c6595567417))
* **youtube/custom-seekbar-color:** apply custom seekbar color to shorts ([ddbf533](https://github.com/ayushTNM/revanced-patches/commit/ddbf533809241a7c3f9b3b9fa0d8e26308b5588d))
* **youtube/enable-new-thumbnail-preview:** forcibly disable when the switch is off ([639e40d](https://github.com/ayushTNM/revanced-patches/commit/639e40d707c63bcd46db41a97f57c80cd0e15bdb))
* **youtube/enable-old-quality-layout:** do not use low level filter anymore ([599c30a](https://github.com/ayushTNM/revanced-patches/commit/599c30adc898e316fe3e3ae2644871818e75fbcf))
* **youtube/enable-old-quality-layout:** match with the official Revanced ([ee5fc11](https://github.com/ayushTNM/revanced-patches/commit/ee5fc11958c87e44e969734c457de944d34dfe4e))
* **youtube/hide-button-container:** now it support versions other than YouTube v18.20.39 https://github.com/ReVanced/revanced-patches/pull/2723 ([1fbb5c4](https://github.com/ayushTNM/revanced-patches/commit/1fbb5c4beebb9b32d7bb015aadc4855381f80329))
* **youtube/hide-comment-component:** `hide preview comment` hides the dots of live comments ([c80d0e7](https://github.com/ayushTNM/revanced-patches/commit/c80d0e7ba42244d4fe4bb43dac1b124a3e734414))
* **youtube/hide-layout-components:** add `Hide chips shelf` settings https://github.com/inotia00/ReVanced_Extended/issues/1180 ([5b872de](https://github.com/ayushTNM/revanced-patches/commit/5b872de2824f8be0901f5bfdafa282800db08762))
* **youtube/hide-layout-components:** change the default value of `Hide expandable chip under video` ([d1f2fc6](https://github.com/ayushTNM/revanced-patches/commit/d1f2fc6a6f079a816df56f221d67e38cc45a269e))
* **youtube/hide-player-flyout-panel:** add `Hide lock screen menu` settings ([0e83d2c](https://github.com/ayushTNM/revanced-patches/commit/0e83d2ca39c27fa7c22d43ee8ba3a3abc92b4092))
* **youtube/hide-suggested-video-overlay:** no longer dependent on `overlay-buttons` patches ([837a54c](https://github.com/ayushTNM/revanced-patches/commit/837a54c0f58fead0dd91c2bc5f787676c8ea4688))
* **youtube/language-switch:** add a new type of string ([fc668c3](https://github.com/ayushTNM/revanced-patches/commit/fc668c3421e8c5a33c56d2c04ea57cd1c47faad3))
* **youtube/navbar-index-hook:** no longer depend on low-level filters ([2d4ffd6](https://github.com/ayushTNM/revanced-patches/commit/2d4ffd61b49141095f2f42f2b862f0c3bf435f32))
* **youtube/spoof-app-version:** add 18.09.39 to version list ([86647ab](https://github.com/ayushTNM/revanced-patches/commit/86647ab4d18f235fabdd736a29ba93097c659aab))
* **youtube/spoof-player-parameters:** match with official revanced patches ([2ade6e4](https://github.com/ayushTNM/revanced-patches/commit/2ade6e49d910ee0d90794ae3137b4af5e633d3da))
* **youtube/spoof-player-parameters:** no longer automatically spoofed ([e3b3c09](https://github.com/ayushTNM/revanced-patches/commit/e3b3c09c9578ce6400d6a44785305d1f971c5c8a))
* **youtube/spoof-player-parameters:** no longer automatically spoofed ([a250124](https://github.com/ayushTNM/revanced-patches/commit/a2501245a826510972996bb68d96712f7ecced85))
* **youtube/spoof-player-parameters:** set default value to `on` in non-root environments only ([8c90204](https://github.com/ayushTNM/revanced-patches/commit/8c90204f088aea5802bd2c5428d70a68fa540921))
* **youtube/spoof-player-parameters:** switch default spoofing type ([d80ad01](https://github.com/ayushTNM/revanced-patches/commit/d80ad011d45d08048e0a371bb88600d3c849fbf9))
* **youtube/translations:** update translation ([adcc265](https://github.com/ayushTNM/revanced-patches/commit/adcc26564dcc37af5d8b1d5a933bd2d02a6c8b98))
* **youtube/translations:** update translation ([7442a45](https://github.com/ayushTNM/revanced-patches/commit/7442a45957c2ab4d61953e7554d3195c732b7f5e))
* **youtube/translations:** update translation ([15fbe7d](https://github.com/ayushTNM/revanced-patches/commit/15fbe7d12cd8da72f9699afad81f6359ae68781b))
* **youtube/translations:** update translation ([7742b5f](https://github.com/ayushTNM/revanced-patches/commit/7742b5f5b39507e8bdc2fc45a485115e2d2b4134))
* **youtube/translations:** update translation ([805adc8](https://github.com/ayushTNM/revanced-patches/commit/805adc816f88a0d73c4355a185f6b5a9db9e88f4))
* **youtube/translations:** update translation ([b6a2c2b](https://github.com/ayushTNM/revanced-patches/commit/b6a2c2b8ecdf8ceb41b827e7beea0c1aefe25a1f))
* **youtube/translations:** update translation ([e03b36f](https://github.com/ayushTNM/revanced-patches/commit/e03b36fbcb2500bf00bdc6753e906d625b16d268))
* **youtube/translations:** update translation ([cadc272](https://github.com/ayushTNM/revanced-patches/commit/cadc2720964d68118077c46740acb5c465a0c9fd))
* **youtube:** add `hide-latest-videos-button` patch ([ab663b8](https://github.com/ayushTNM/revanced-patches/commit/ab663b8820e8a042bc5ca2fec68e072f549ea0eb))
* **youtube:** add `hide-suggested-video-overlay` patch ([b03dee0](https://github.com/ayushTNM/revanced-patches/commit/b03dee0549933a6589d431a9b1c5c3f0d43f877b))
* **youtube:** add support version `v18.19.36` & `v18.31.40` ([47b2ed2](https://github.com/ayushTNM/revanced-patches/commit/47b2ed2104ad4ceaadc9daff3d0f98731a54b2c9))
* **youtube:** add support version `v18.27.35` ([db82839](https://github.com/ayushTNM/revanced-patches/commit/db82839a9c47d404aaf829a9e19d87c35cc81c74))
* **youtube:** add support version `v18.27.36` ([09d06fc](https://github.com/ayushTNM/revanced-patches/commit/09d06fc184c1ee40fca24d5f542e9840abf5fa77))
* **youtube:** add support version `v18.29.38` ([0b09058](https://github.com/ayushTNM/revanced-patches/commit/0b090583286b8f6c3104b3e00a08aa3c7d0abc9b))
* **youtube:** add support version `v18.30.37` ([d8a10fe](https://github.com/ayushTNM/revanced-patches/commit/d8a10fecf593954031180bd59e51556b850074d4))
* **youtube:** minor improvement ([eaced95](https://github.com/ayushTNM/revanced-patches/commit/eaced9527e656060c5e2bb04e925b7c2616af6af))
* **youtube:** preparation for discontinuation ([22db45a](https://github.com/ayushTNM/revanced-patches/commit/22db45a6f1ceecd284d94c777b8865ddf20e2676))
